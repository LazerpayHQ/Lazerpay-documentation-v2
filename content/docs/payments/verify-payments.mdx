...
<CodeBlock responseTheme="red" responseTitle="Response" data={{type: 'request', item: {method: "GET", requestData: {name: ['cURL', 'Node'], snippet: ['verifyPaymentGetCURL', 'verifyPaymentGetCURL'], lang: ['curl', 'curl']}, responseData: {name: ['200: OK', '401: Unauthorized'], snippet: ['customerInfoReq201', 'customerInfoReq401'], lang: ['json', 'json']}} }} />
