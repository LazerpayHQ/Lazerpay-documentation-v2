...
<CodeBlock
    data={{
        ...
        item: {
            ...
            snippet: ['customerInfoHTML', 'customerInfoJS'],
            lang: ['html', 'js']
            }
        }}
    />
...
<CodeBlock
    ...
    data={{
        ...
        item: {method: "POST", requestData: {
            name: ['cURL', 'Node'],
            snippet: ['initializePaymentPostCURL', 'initializePaymentPostNode'],
            lang: ['curl', 'js']
        },
        responseData: {
            name: ['201: Created', '401: Unauthorized'],
            snippet: ['initializePaymentRes201', 'initializePaymentRes401'],
            lang: ['json', 'json']
        }}
    }}
/>
...
<CodeBlock
    ...
    data={{
        ...
        item: { requestData: {
            name: ['Node'],
            snippet: ['initializePaymentNodeSDKSample'],
            lang: ['js']
        },
        responseData: {
            name: ['201: Created'],
            snippet: ['initializePaymentNodeSDKSampleResponse'],
            lang: ['json']
        }}
    }}
/>
