...
<ResCodeBlock options req1='Hide Response' id1='nodeJsSdkSample'/>

<ResCodeBlock options req1='Response JSON' id1='nodeJsSdkSampleResponse' className='!bg-white code-war-500' lang='json'/>
