...
<CodeBlock data={{type: 'tab', item: {heading: ['HTML', 'JAVASCRIPT'], snippet: ['customerInfoHTML', 'customerInfoJS'], lang: ['html', 'js']}}} />
<CodeBlock data={{type: 'request', item: {method: "POST", requestType: [{name: 'cURL', snippet: 'customerInfoPostCURL'},{name: 'Node', snippet: 'customerInfoPostNode'}], responseType: [{name: '201: Created', snippet: 'customerInfoReq201'}]} }} />
