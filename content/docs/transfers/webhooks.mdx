...
## Enabling WebHooks
You can specify your webhook URL on <code>your dashboard</code> and where we will send <code>POST</code> request 
...
<li>
<code>1</code> Login to your <code>dashboard</code> and on <b>settings</b>
</li>
<li>
<code>2</code> Navigate to the <b>API Keys and WeebHooks tab</b>
</li>
<li>
<code>3</code> Specify your webhook url and click on <b>Update</b>
</li>
</ul>
...
is computed by generating a hash from concatenating your API key and request body, using the 
...
care about the response body or headers</b>
...
Here are the webhook request type that we support. We will add more to the list as we keep adding
