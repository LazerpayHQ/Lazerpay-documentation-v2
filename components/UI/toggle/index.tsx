...
const Toggle = (props: ToggleProps) => {
  ...
  return (
    <label className={cn(Styles.toggle, { 'bg-neu-200': !checked, 'bg-suc-500': checked })} onClick={() => setChecked(prev => !prev)}>
      <input type="checkbox" className="toggle" id="toggle" onChange={onToggle} checked={checked} />
